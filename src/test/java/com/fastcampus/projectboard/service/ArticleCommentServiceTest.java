...
class ArticleCommentServiceTest {
    ...
    */
    ...
    void givenArticleId_whenSearchingArticleComments_thenReturnsArticleComments() {
        ...
        given(articleCommentRepository.findByArticle_Id(articleId)).willReturn(List.of(expected)); // id입력하고 댓글 반환

        // When
        List<ArticleCommentDto> actual = sut.searchArticleComments(articleId); // id로 댓글 조회

        // Then
        assertThat(actual)
                .hasSize(1) // 댓글 하나
                .first().hasFieldOrPropertyWithValue("content", expected.getContent()); // 첫 번째 댓글의 content가 expected의 content와 일치하는지
    ...
    void givenArticleCommentInfo_whenUpdatingArticleComment_thenUpdatesArticleComment() {
        ...
        ArticleComment articleComment = createArticleComment(oldContent); // 이전 댓글
        ArticleCommentDto dto = createArticleCommentDto(updatedContent); // 수정할 댓글
